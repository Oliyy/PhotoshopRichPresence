...
#define kexpFeatureCanvasSizeRatioStr "expFeatureCanvasSizeRatio" // TODO (cyan): temporary old behavior for when the feature flag is disabled.
...
#define kindexFramedGroupStr "indexFramedGroup"
