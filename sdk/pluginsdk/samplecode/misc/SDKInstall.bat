echo off
echo.
echo Copy the SDK examples to the common location where Photoshop CC will find them. 
...
set ps_cc_2018_32="NOT INSTALLED"
...
FOR /F "tokens=%RegTokens%* delims=	 " %%A IN ('REG QUERY "HKLM\SOFTWARE\Adobe\Photoshop\120.0\PluginPath" ') DO SET ps_cc_2018="%%B"
IF %PROCESSOR_ARCHITECTURE%==AMD64 (
 ...
 FOR /F "tokens=%RegTokens%* delims=	 " %%A IN ('REG QUERY "HKLM\SOFTWARE\Wow6432Node\Adobe\Photoshop\120.0\PluginPath" ') DO SET ps_cc_2018_32="%%B"
) ELSE (
...
echo 7.  Photoshop CC  2018 32 bit     %ps_cc_2018_32%
IF %PROCESSOR_ARCHITECTURE%==AMD64 (
 echo 8.  Photoshop CS6 64 bit          %ps_cs6_13%
 echo 9.  Photoshop CC  64 bit          %ps_cc_14%
 echo A.  Photoshop CC  2014 64 bit     %ps_cc_2014%
 echo B.  Photoshop CC  2015 64 bit     %ps_cc_2015%
 echo C.  Photoshop CC  2015.5 64 bit   %ps_cc_2015_5%
 echo D.  Photoshop CC  2017 64 bit     %ps_cc_2017%
 echo E.  Photoshop CC  2018 64 bit     %ps_cc_2018%
)
...
if "%userinp%"=="7" goto CC201832
if "%userinp%"=="8" goto CS664
if "%userinp%"=="9" goto CC64
if "%userinp%"=="A" goto CC201464
if "%userinp%"=="B" goto CC201564
if "%userinp%"=="C" goto CC2015564
if "%userinp%"=="D" goto CC201764
if "%userinp%"=="E" goto CC201864
if "%userinp%"=="F" goto DEFAULTCOMMON
...
goto SDK
:CC201832
echo Photoshop CC 2018 32
set ps_install_path=%ps_cc_2018_32%
goto SDK
:CS664
...
:D32
echo Debug 32
set sdk_source_path=..\Output\Win\Debug\*.8??
goto COPY
:D64
echo Debug 64
set sdk_source_path=..\Output\Win\Debug64\*.8??
goto COPY
:R32
echo Release 32
set sdk_source_path=..\Output\Win\Release\*.8??
goto COPY
:R64
echo Release 64
set sdk_source_path=..\Output\Win\Release64\*.8??
goto COPY
:DEF
